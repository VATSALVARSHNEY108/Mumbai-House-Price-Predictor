...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            numerical_features = ['Area', 'No_of_Bedrooms', 'New_Resale', 'Gymnasium', 'Lift_Available',
            'Car_Parking', 'Maintenance_Staff', '_24x7_Security','Childrens_Play_Area', 'Clubhouse', 'Intercom', 'Landscaped_Gardens',
